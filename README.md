...
> **💡 Note:** There is  ```.vscode/settings.json``` committed with configuration of 
> [Explorer sort](https://marketplace.visualstudio.com/items?itemName=jinchanghyeok.explorer-sort) Visual Studio Code plugin 
> which allows to set any custom order in explorer tree, so when you open this repo in VSC, you should see the same order as in published version.
